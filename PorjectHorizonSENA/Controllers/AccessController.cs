...
namespace PorjectHorizonSENA.Controllers
{
    public class AccessController : Controller
    {
        ...
        private char[] str;        public AccessController(IUsuarioService usuarioService)
        {
        ...
        public async Task<IActionResult> Register(VMRegister registerModel)
        {
            if (registerModel != null)
            {
                ...
                Usuario temporaryUser = new Usuario
                {
                    NumeroDeDocumento = registerModel.NumeroDeDocumento,
                    TipoDeDocumento = registerModel.TipoDeDocumento,
                    Nombres = registerModel.Nombres,
                    PrimerApellido = registerModel.PrimerApellido,
                    SegundoApellido = registerModel.SegundoApellido,
                    Correo = registerModel.Correo,
                    Contrasena = registerModel.Contrasena,
                    Municipio = registerModel.Municipio,
                    Departamento = registerModel.Departamento,
                    CentroDeFormacion = registerModel.CentroDeFormacion,
                    FichaAprendiz = registerModel.FichaAprendiz,
            ...
            try
            {
                ...
                if (user != null )
                {
                    ...
                    var claims = new List<Claim>()
                 {
                    ...
                    return RedirectToAction("Index", "File", new { role = ((Usuario)user).Rol.NombreRol, userId = user.UsuarioId, userNombre = user.Nombres });
                }
